...
export default function DeskEnvironment({
  ...
  return (
    <div className={`desk-scene ${goldenRush ? "desk-scene--golden" : ""} desk-tier--${theme.tier}`}>
      {/* Room */}
      ...
      <div className="desk-pov">
        <div className="desk-surface" style={{ backgroundColor: theme.deskWood }}>
          ...
          {/* Monitor */}
          <div className="desk-monitor-wrap" style={{ width: theme.monitorSize }}>
            <div className="desk-monitor-stand" />
            <div className={`desk-monitor ${goldenRush ? "desk-monitor--golden" : ""}`}>
              <div className="desk-monitor-bezel">
                <div className="desk-monitor-power" />
                <div className="desk-monitor-brand">ME Pro</div>
              </div>
              <div className="desk-monitor-screen">{children}</div>
          ...
          <div className="desk-keyboard-area">
            ...
            <PlayerHands typing={typing} clicking={clicking} />
          </div>
        </div>
      </div>
    </div>
